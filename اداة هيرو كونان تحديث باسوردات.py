#• DeCoDe By @KO00NAN •
import webbrowser
na = webbrowser.open('https://www.facebook.com/profile.php?id=100052089186869')
import requests
import bs4
import json
import os
...
g= datetime.datetime(2023, 11, 21, 7, 10 ,9)

# if (x.strftime("%x"))>(g.strftime("%x")):
 # print('\n\n')
 # print("     "+'توقفت الاداة راسل كونان للاشتراك /n @KO00NAN
 # print('\n\n')
 # print(x)
...
# if (x.strftime("%x"))==(g.strftime("%x")):
   ...
   # if(x.strftime("%X"))>(g.strftime("%X")):
    # print('\n\n')
    # print("     "+'خلص اشتراك عليك مراجعة صانع اداة@KO00NAN')
    # print('\n\n')
    # print(x)
...
def banner():
	...
	print('• DeCoDe By @KO00NAN•')
	print('—'*25)
	print(L+f'''to  -  @hkeraldola  @KO00NAN صور الصيد هون''')
	print('—'*25)
	print('• DeCoDe By @KO00NAN •')
	print('—'*25)
...
def menu(my_name,my_id):
	...
	banner()
	print(B+'°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
	print(L+'@hkeraldola  • 𓆩KONAN𓆪 @KO00NAN 𓆩KONAN𓆪  @haker_249')
	print(L+'PY  -  𓆩KONAN𓆪 new update ')
	print(B+'°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [𓆩KONAN𓆪] %s/%s ➙ [ [OK] %s ➙\033[1ll [ [CP] %s .. } %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
𓆩𝐇𝐄𝐑𝐎𓆪 Get you an inactive account ❌
⋘─────━𓆩KONAN𓆪‏━─────⋙
♚ ☞ @hkeraldola  -  @KO00NAN - @haker_249'''
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='هيرو جابلك حساب سكيور '))
...
❖ - 𝐔𝐒𝐄𝐑𝐍𝐀𝐌 : {idf}\n
❖ - 𝐏𝐀𝐒𝐒𝐖𝐑𝐃 : {pw}\n
𓆩𝐇𝐄𝐑𝐎𓆪 Get yourself a working account ✅
⋘─────━𓆩KONAN𓆪━─────⋙
♚ ☞ @hkeraldola  -  @KO00NAN - @haker_249'''
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title=' هيرو جابلك حساب شغال '))
